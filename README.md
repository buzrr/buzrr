...
**Real-time, multiplayer quiz battles.** Host live Kahoot-style games, go
head-to-head in ranked 1v1 duels, and generate whole quizzes with AI.

[![CI](https://github.com/buzrr/buzrr/actions/workflows/ci.yml/badge.svg)](https://github.com/buzrr/buzrr/actions/workflows/ci.yml)
...
- 🎮 **Live multiplayer quizzes** — host a room, players join with a code, everyone answers in real time over WebSockets.
- ⚔️ **Ranked 1v1 duels** — matchmaking with an **ELO** rating system.
...
- **Google OAuth credentials** — the only thing you *must* provide, or login won't work.
